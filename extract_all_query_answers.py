...
This file runs searches for all shapes in the database.
It tests each shape as a query and finds similar shapes.
It saves results to CSV files for later evaluation.
It tests multiple distance metrics at once.
This creates the data needed to measure system performance.
"""
...
def generate_retrieval_results_wide_format():
     ...
     out_path = 'QueryResults/results_neutral.csv'
