...
if __name__ == '__main__':
    ...
    perplexity_val = 10  # Default value
    while True:
        try:
    ...
    X_2d = compute_tsne(X_scaled, perplexity=perplexity_val, max_iter=10000)

    # Ask user if they want to save the full map
    save_choice = input("Save the full t-SNE map to a PNG file? (y/n): ").strip().lower()
    if save_choice in ('y', 'yes'):
        save_full_tsne_map(all_features_df, X_2d, 'Zooi van thies/tsne_full_map.png')
